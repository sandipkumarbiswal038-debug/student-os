  ...
  return (
    <div className="student-container">
      ...
      {subjects.some((item) => item.percentage < 75) && (
        <div className="student-attendance-warning">
          <strong>Attendance Alert:</strong> One or more subjects are below 75%.
        </div>
      )}
          ...
          <table className="student-table">
            ...
            <tbody>
              ...
              {subjects.map((item, index) => (
                ...
                <tr
                  key={index}
                  className={`attendance-${getAttendanceState(item.percentage)}`}
                >
                  ...
                  <td>
                    ...
                    <div className="student-progress-box">
                      ...
                      <span
                        className={`attendance-indicator ${getAttendanceState(item.percentage)}`}
                      >
                        {item.percentage}%
                      </span>
